...
import com.worldproxies.orchid.circuits.CircuitManagerImpl;
import com.worldproxies.orchid.circuits.TorInitializationTracker;
import com.worldproxies.orchid.config.TorConfigProxy;
import com.worldproxies.orchid.connections.ConnectionCacheImpl;
import com.worldproxies.orchid.directory.DirectoryImpl;
import com.worldproxies.orchid.directory.downloader.DirectoryDownloaderImpl;
import com.worldproxies.orchid.socks.SocksPortListenerImpl;
...
//	 * @param logManager This is a required dependency.  You must create a <code>LogManager</code>
	...
	static public ConnectionCache createConnectionCache(TorConfig config, TorClientConfig clientConfig, TorInitializationTracker tracker) {
		return new ConnectionCacheImpl(config, clientConfig, tracker);
	}
	/**
	 ...
	 * @see CircuitManager
	 */
	static public CircuitManager createCircuitManager(TorConfig config, TorClientConfig clientConfig, DirectoryDownloaderImpl directoryDownloader, Directory directory, ConnectionCache connectionCache, TorInitializationTracker tracker) {
		return new CircuitManagerImpl(config, clientConfig, directoryDownloader, directory, connectionCache, tracker);
	}
