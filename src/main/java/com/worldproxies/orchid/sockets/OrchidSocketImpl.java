package com.worldproxies.orchid.sockets;
...
import com.worldproxies.orchid.TorClient;
...
public class OrchidSocketImpl extends SocketImpl {
	...
	private void doConnect(String host, int port) throws IOException {
		...
		// Try to avoid holding the stream lock here whilst calling into torserver to avoid accidental inversions.
