...
import com.worldproxies.orchid.HiddenServiceCircuit;
import com.worldproxies.orchid.InternalCircuit;
import com.worldproxies.orchid.Router;
import com.worldproxies.orchid.circuits.CircuitNodeCryptoState;
import com.worldproxies.orchid.circuits.CircuitNodeImpl;
import com.worldproxies.orchid.crypto.TorMessageDigest;
import com.worldproxies.orchid.crypto.TorRandom;
import com.worldproxies.orchid.crypto.TorTapKeyAgreement;
import com.worldproxies.orchid.data.HexDigest;
import com.worldproxies.orchid.RelayCell;
...
public class RendezvousProcessor {
	...
	HiddenServiceCircuit processRendezvous2(TorTapKeyAgreement kex) {
		...
		return circuit.connectHiddenService(
                CircuitNodeImpl.createAnonymous(circuit.getFinalCircuitNode(), keyMaterial, verifyHash));
	}
