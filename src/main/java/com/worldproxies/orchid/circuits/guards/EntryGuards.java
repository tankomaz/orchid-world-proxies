...
import com.worldproxies.orchid.circuits.path.CircuitNodeChooser;
import com.worldproxies.orchid.circuits.path.RouterFilter;
...
public class EntryGuards {
	...
	public EntryGuards(TorConfig config, TorClientConfig clientConfig, ConnectionCache connectionCache, DirectoryDownloader directoryDownloader, Directory directory) {
		this.config = config;
		this.random = new TorRandom();
		this.nodeChooser = new CircuitNodeChooser(clientConfig, directory);
