...
public class CircuitNodeChooser {
	...
	public CircuitNodeChooser(TorClientConfig clientConfig, Directory directory) {
		this.directory = directory;
		this.configNodeFilter = new TorConfigNodeFilter(clientConfig);
	}

    public TorConfigNodeFilter getConfigNodeFilter() {
        return configNodeFilter;
    }
