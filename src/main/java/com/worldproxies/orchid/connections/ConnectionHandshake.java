...
import com.worldproxies.orchid.BridgeRouter;
...
public abstract class ConnectionHandshake {
	...
	static ConnectionHandshake createHandshake(TorConfig config, ConnectionImpl connection, SSLSocket socket) throws
