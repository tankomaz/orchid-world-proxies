...
public class HiddenService {
	...
	private com.subgraph.orchid.circuits.hs.HSDescriptor descriptor;
	...
	com.subgraph.orchid.circuits.hs.HSDescriptor getDescriptor() {
		return descriptor;
	}

	void setDescriptor(com.subgraph.orchid.circuits.hs.HSDescriptor descriptor) {
	...
	com.subgraph.orchid.circuits.hs.HSDescriptorCookie getAuthenticationCookie() {
	...
	byte[] getCurrentSecretId(int replica) {
		...
		final com.subgraph.orchid.circuits.hs.HSDescriptorCookie cookie = getAuthenticationCookie();
